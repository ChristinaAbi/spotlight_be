...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { description: @artwork.description, name: @artwork.name, price: @artwork.price } }, as: :json
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { description: @artwork.description, name: @artwork.name, price: @artwork.price } }, as: :json
    assert_response 200
  end
